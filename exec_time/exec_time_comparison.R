...
newton_raphson_quadratic_R <- function(T_n, n, 
  ...
  fobj <- function(alpha){
    ...
    h <- (T_n - T_inf2 + m*alpha2 + beta_n*T_n/n)*alpha + (beta_n_alpha_1_2*T_n/n)*sqrt(alpha) + beta_nalpha*T_n/n - m*alpha*alpha;
    return(h)
  }
  derobj <- function(alpha){
    m <- (T_inf2 - T_inf1)/(alpha2 - alpha1);
    der <- (T_n - T_inf2 + m*alpha2 + beta_n*T_n/sqrt(n)) + 1/2*(beta_n_alpha_1_2*T_n/n)/sqrt(alpha) - 2*m*alpha;
    return(der)
  }
...
p_cir_stat_CvM <- function(T_n, n){
  ...
  m <- length(alpha_grid)
  T_inf <- c(1.167869, 1.03846, 0.9633351, 0.9103154, 0.8693864, 0.8360821, 0.8080174, 0.7837828, 0.7624706, 0.7434891, 0.7262938, 0.7106819, 0.6963499, 0.6831086, 0.6708072, 0.6593525, 0.6485588, 0.6384363, 0.6288909, 0.6197956, 0.6112114, 0.6030277, 0.5952203, 0.5877707, 0.5806214, 0.5737654, 0.5671797, 0.5608443, 0.5547412, 0.5488543, 0.5431421, 0.5376563, 0.5323439, 0.5271954, 0.5222018, 0.5173548, 0.5126467, 0.5080701, 0.5036184, 0.4992852, 0.4950577, 0.4909746, 0.4869476, 0.4830278, 0.4792077, 0.4754568, 0.471827, 0.4682607, 0.464771, 0.4613538, 0.4580049, 0.4547201, 0.4515563, 0.4484017, 0.445322, 0.4423021, 0.4393398, 0.4364336, 0.4335817, 0.4307826, 0.4280349, 0.4252765, 0.4226228, 0.4200009, 0.4174821, 0.4149427, 0.4124424, 0.4099876, 0.4075772, 0.4052044, 0.4028679, 0.4005669,0.3983004, 0.3960669, 0.3938653, 0.3916953, 0.3895561, 0.3874467, 0.3853665, 0.3833147, 0.3812906, 0.3792935, 0.3773227, 0.3753777, 0.3734577, 0.3715622, 0.3696907, 0.3678424, 0.3660171, 0.364214, 0.3624327, 0.3606728, 0.3589337, 0.357215, 0.3555163, 0.3538371, 0.352177, 0.3505357, 0.3489127, 0.3473077, 0.3457203, 0.3441502, 0.3425969, 0.3410603, 0.3395399, 0.3380354, 0.3365466, 0.3350731, 0.3336147, 0.3321711, 0.3307419, 0.329324, 0.3279232, 0.3265362, 0.3251626, 0.3238023, 0.3224549, 0.3211204, 0.3197984, 0.3184887, 0.3171912, 0.3159057, 0.3146319, 0.3133696, 0.3121186, 0.3108789, 0.3096501, 0.3084321, 0.3072248, 0.306028, 0.3048414, 0.303665, 0.3024986, 0.3013421, 0.3001952, 0.2990579, 0.2979299, 0.2968113, 0.2957017, 0.2945745, 0.2934823, 0.2923989, 0.2913241, 0.2902577, 0.2891997, 0.28815, 0.2871083, 0.2861357, 0.28511, 0.2840921, 0.2830818, 0.2820791, 0.2810839, 0.2800829, 0.2791023, 0.278129, 0.2771627, 0.2762035, 0.2752512, 0.2743058, 0.2733671, 0.272435, 0.2715095, 0.2705906, 0.269678, 0.2687718, 0.2678718, 0.266978, 0.2660903, 0.2652087, 0.2643329, 0.2634631, 0.2625991, 0.2617408, 0.2608882, 0.2600413, 0.2591998, 0.2583639, 0.2575333, 0.2567081, 0.2558882, 0.2550735, 0.254264, 0.2534596, 0.2526602, 0.2518659, 0.2510765, 0.250292, 0.2495123, 0.2487374, 0.2479672, 0.2472017, 0.2464408, 0.2456845, 0.2449327, 0.2441854, 0.2434426, 0.2427041, 0.24197, 0.2412401, 0.2405145, 0.2397931, 0.2390759, 0.2383628,0.2376537, 0.2369487, 0.2362477, 0.2355507, 0.2348575, 0.2341683, 0.2334828, 0.2328012, 0.2321252, 0.2314533, 0.2307851, 0.2301204, 0.2294593, 0.2288017, 0.2281476, 0.227497, 0.2268497, 0.2262058, 0.2255653, 0.2249281, 0.2242943, 0.2236636, 0.2230362, 0.2224121, 0.22173, 0.2211122, 0.2204974, 0.2198858, 0.2192772, 0.2186717, 0.2180692, 0.2174697, 0.2168731, 0.2162795, 0.2156888, 0.2151009, 0.214516, 0.2139339, 0.2133546, 0.2127781, 0.2122043, 0.2116333, 0.2110651, 0.2104995, 0.2099366, 0.2093764)
